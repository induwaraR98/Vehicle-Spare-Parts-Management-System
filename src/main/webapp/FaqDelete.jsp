      ...
      <div class="row align-items-stretch justify-content-center no-gutters">
        <div class="col-md-7">
          <div class="form h-100 contact-wrap p-5">
            <h3 class="text-center">Let's Delete</h3><br>
            <form class="mb-5" method="post" action = "Delete" >
              <div class="row">
              ...
              <div class="row mb-5">
                <div class="col-md-12 form-group mb-3">
                  ...
                  <input type="text" class="form-control" name="Question" id=" question" value ="<%=question%>" readonly>              
                </div>
              </div>
